...
rgb (Invert c) = zipWith (-) [1,1,1] (rgb c)
...
prettyPrint End = ""
prettyPrint (O rest) = "0"++prettyPrint rest
prettyPrint (I rest) = "I"++prettyPrint rest


-- Holy Shit
fromBin :: Bin -> Int
fromBin End = 0
fromBin (I rest) = fromBin rest * 2 + 1
fromBin (O rest) = fromBin rest * 2
