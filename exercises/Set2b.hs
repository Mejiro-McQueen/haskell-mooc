...
countdown_help 0 = "Liftoff!"
countdown_help n = show n ++ "... " ++ countdown_help (n-1)
countdown n = "Ready! " ++ countdown_help n 
...
smallestDivisor n = head $ filter (\x-> mod n x == 0) [2..]
...
biggestPrimeAtMost n = maximum $ filter isPrime [2..n]
